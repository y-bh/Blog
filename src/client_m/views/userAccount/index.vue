  ...
  <div class="userAccount">
    <div class="account pt-40">
      <div class="left mb-10">
        <div class="user-info">
          <span class="user-name mr-20">用户名</span><span>zhangsan</span>
    ...
    <div class="operation">
      ...
      <div class="operate-box operate-box-big ml-20 mr-20 mt-20 mb-20">
        ...
        <div class="group-btn mt-20 alginRight">
      ...
      >
        <div class="saleInfo">
          ...
          <div class="sale-name mt-20">
            <span>风清扬</span><span class="ml-15">销售经理</span>
          </div>
          <div class="telep mt-20">
            <span>18809098787</span>
